...
public struct RefresherData {
    let lastUpdate: String
    let numberOfTweets: Int

    public init(lastUpdate: String, numberOfTweets: Int) {
...
open class PullToRefresh: NSObject {
    ...
    public init(refreshView: DefaultRefreshView, animator: RefreshViewAnimator, height: CGFloat, position: Position) {
